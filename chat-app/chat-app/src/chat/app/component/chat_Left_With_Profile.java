...
//        txt.setImage(false, image);
    ...
    private void initComponents() {
        ...
        IaImage = new chat.app.swing.ImageAvatar();
        txt = new chat.app.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/chat/app/icon/testing/dog.jpg"))); // NOI18N
    ...
    private chat.app.swing.ImageAvatar IaImage;
